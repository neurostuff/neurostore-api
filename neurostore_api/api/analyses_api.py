...
class AnalysesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.analyses_get = _Endpoint(
            ...
            callable=__analyses_get
        )

        def __analyses_id_get(
            self,
            id,
            **kwargs
        ):
        ...
        self.analyses_id_get = _Endpoint(
            settings={
                'response_type': (object,),
                'auth': [],
            ...
            api_client=api_client,
            callable=__analyses_id_get
        )

        def __analyses_id_put(
            self,
            id,
            **kwargs
        ):
        ...
        self.analyses_id_put = _Endpoint(
            settings={
                'response_type': None,
                'auth': [],
                'endpoint_path': '/analyses/{id}',
