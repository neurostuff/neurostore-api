...
class DatasetsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.datasets_get = _Endpoint(
            ...
            callable=__datasets_get
        )

        def __datasets_id_get(
            self,
            id,
            **kwargs
        ):
        ...
        self.datasets_id_get = _Endpoint(
            settings={
                'response_type': (object,),
                'auth': [],
            ...
            api_client=api_client,
            callable=__datasets_id_get
        )

        def __datasets_id_put(
            self,
            id,
            **kwargs
        ):
        ...
        self.datasets_id_put = _Endpoint(
            settings={
                'response_type': None,
                'auth': [],
                'endpoint_path': '/datasets/{id}',
